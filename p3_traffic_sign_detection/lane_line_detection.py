...
def birdview_transform(img):
    ...
    IMAGE_H = 480
    IMAGE_W = 640
    src = np.float32([[0, IMAGE_H], [640, IMAGE_H], [
                     0, IMAGE_H * 0.4], [IMAGE_W, IMAGE_H * 0.4]])
    dst = np.float32([[240, IMAGE_H], [640 - 240, IMAGE_H],
                     [-160, 0], [IMAGE_W+160, 0]])
...
def calculate_control_signal(img, draw=None):
    ...
    left_point, right_point = find_left_right_points(
